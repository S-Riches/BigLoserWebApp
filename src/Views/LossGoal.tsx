...
const LossGoal = () => {
    ...
    return (
        <div>
            ...
            <h5>
                a kilogram of body fat is made up of 7,700kcals. to lose that in
                a week you would need to lower your calorie intake by 1100kcals
                a day
            </h5>
            <select
            ...
            {isVeryLow && (
                <h3>
                    As your Target calorie goal is below 1,500kcals - please
                    either reconsider your goal, or speak to a professional
                    nutritionist.
                </h3>
            )}
        </div>
